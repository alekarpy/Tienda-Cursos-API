...
export class AdminProductFormComponent implements OnInit {
    ...
    loadProduct(id: string) {
        this.loading = true;
        console.log(`📦 [AdminProductForm] loadProduct() → Cargando producto ${id}`);
    ...
    onSubmit() {
        ...
        console.log(`📦 [AdminProductForm] onSubmit() → ${this.isEditMode ? 'Actualizando' : 'Creando'} producto:`, productData);
        ...
        operation.subscribe({
            next: (response) => {
                console.log(`✅ [AdminProductForm] Producto ${this.isEditMode ? 'actualizado' : 'creado'}:`, response);
                this.router.navigate(['/admin/products']);
            },
            error: (err) => {
                console.error(`❌ [AdminProductForm] Error al ${this.isEditMode ? 'actualizar' : 'crear'} producto:`, err);
                this.error = `Error al ${this.isEditMode ? 'actualizar' : 'crear'} producto. Por favor, intenta nuevamente.`;
                this.loading = false;
            }
        });
    }
